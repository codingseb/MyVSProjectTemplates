using $safeprojectname$.PluginInfrastructure;
using System;
using System.Text;
...
namespace $safeprojectname$
{
    public class BNpp
    {
        ...
        public static string Text
        {
            get
            {
                IScintillaGateway scintilla = Scintilla;
        ...
        public static int SelectionStart
        {
            get
            {
                return Scintilla.GetSelectionStart();
            }

            set
            {
                Scintilla.SetSelectionStart(new Position(value));
            }
        }
