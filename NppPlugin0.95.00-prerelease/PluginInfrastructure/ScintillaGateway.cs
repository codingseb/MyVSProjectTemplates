...
using System.Text;
using static $safeprojectname$.PluginInfrastructure.Win32;
...
namespace $safeprojectname$.PluginInfrastructure
{
    ...
    public class ScintillaGateway : IScintillaGateway
    {
        ...
        public Position FindText(FindOption searchFlags, TextToFind ft)
        {
            IntPtr res = Win32.SendMessage(scintilla, SciMsg.SCI_FINDTEXT, (int)searchFlags, ft.NativePointer);
			return new Position((int)res);
        }
